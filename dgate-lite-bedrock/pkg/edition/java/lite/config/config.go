...
type (
	...
	Config struct {
		...
		Bedrock Bedrock `yaml:"bedrock,omitempty" json:"bedrock,omitempty"`
	}
	// Bedrock is the configuration for Bedrock support in Lite mode.
	Bedrock struct {
		Enabled bool   `yaml:"enabled,omitempty" json:"enabled,omitempty"`
	...
	Route struct {
		...
		ModifyBedrockIP   bool                             `json:"modifyBedrockIP,omitempty" yaml:"modifyBedrockIP,omitempty"`
